...
class SqlLite private constructor() {
    ...
    companion object {
        private val instance: SqlLite = SqlLite()

        fun getInstance(): SqlLite = instance
    }
    ...
    private fun initialize() {
        ...
        config.jdbcUrl = "jdbc:sqlite:${dbConfig.getString("sql.dbfile")}"
        ...
        try {
            ...
            AstraTowny.instance.logger.log(Level.SEVERE, "Ошибка при настройке HikariCP для SQLite", e)
        }
    }
    ...
    fun getConnection(): Connection? {
        return try {
            ...
            AstraTowny.instance.logger.log(Level.SEVERE, "Ошибка при подключении к базе данных SQLite через HikariCP", ex)
            null
        }
    }
}
